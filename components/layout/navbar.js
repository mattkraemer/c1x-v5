  ...
  return (
    <section class={styles.navbar}>
      <nav class="container-lg">
        ...
        <div class={styles.navSection}>
          <Link target="_blank" href="https://github.com/mattkraemer">
            <svg viewBox="0 0 140 140" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link target="_blank" href="https://www.linkedin.com/in/matthias-kraemer1">
          ...
          <Link target="_blank" href="https://stackoverflow.com/users/7437415/matthias-kr%c3%a4mer">
            <svg viewBox="0 0 140 140" xmlns="http://www.w3.org/2000/svg">
              <g fill="none" stroke-linecap="round" stroke-linejoin="round">
