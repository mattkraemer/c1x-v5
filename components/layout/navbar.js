  ...
  return (
    <section class={styles.navbar}>
      <nav class="container-lg">
        ...
        <a href="" class={styles.logo}><span class={styles.c1x}>c1x</span><span class={styles.dev}>dev</span></a>
        <div class={styles.navSection}>
          <Link href="https://github.com/mattkraemer">
            <a target="_blank">
              <svg viewBox="0 0 140 140" xmlns="http://www.w3.org/2000/svg">
          ...
          <Link href="https://www.linkedin.com/in/matthias-kraemer1">
            <a target="_blank">
          ...
          <Link href="https://stackoverflow.com/users/7437415/matthias-kr%c3%a4mer">
            <a target="_blank">
              <svg viewBox="0 0 140 140" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke-linecap="round" stroke-linejoin="round">
